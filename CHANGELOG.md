...
- **GIF 合成改由 Pillow 做，ffmpeg 只负责抽帧**：Playwright 自带的 ffmpeg 是 `--disable-everything` 编译的，只有 png 编码器和 image2 muxer，**没有 gif muxer，也没有 palettegen / fps 滤镜**，标准的 `fps=..,palettegen,paletteuse` 那套一律报 exit 234
